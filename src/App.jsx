                ...
                <section id="about" className="section about-section">
                    ...
                    <div className="services-container">
                        ...
                        <div className="service-box">
                            ...
                            <p>
                                Our custom-built chatbot, powered by Google Gemini, analyses the company data with surprising clarity. Using just the numbers, it forecasts earnings direction and provides insight into each company’s financial outlook.
