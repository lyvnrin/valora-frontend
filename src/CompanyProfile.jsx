...
const companies = [
    { id: 1, name: "Apple Inc.", industry: "Technology" },
    { id: 2, name: "Amazon", industry: "E-commerce" },
    { id: 3, name: "Google", industry: "Technology" },
    { id: 4, name: "Tesla", industry: "Automotive" },
    { id: 5, name: "Meta", industry: "Technology" }
];

// Extract unique industries + "All"
